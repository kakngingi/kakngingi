...
public class String_01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.equals(str11.toLowerCase()));	//	목적어(소문자)를 주어(대문자) 와 같은형태로 만들어서 변경하여 true 값나오게 하기
		...
		//	String 단점 
	/*	String은 메모리를 과소비합니다.
		초기화된 데이터의 변화가 발생하면 기존것을 사용하지 않고 새로운 메모리를 사용합니다.
		String의 단점을 해소하기위해 StringBuffer, 탄생 
	*/
